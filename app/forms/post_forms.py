...
class PostTypeForm(FlaskForm):
    post_title = StringField('Add a title', validators=[Length(min=1, max=255,  message='Post title must be between 1 and 255 characters')])
    ...
    image_embed_code = StringField('Image Embed Code', validators=[validate_image])
